...
<xsl:template match="/atom:feed">
	...
	<link rel="canonical" href="http://localhost:4000/coderdojorimini//assets/xslt/atom.xslt">
  ...
  <nav class="top-bar" role="navigation" data-topbar>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li><a  href="http://localhost:4000/coderdojorimini//">Start</a></li>
              <li class="divider"></li>
              ...
              <li><a  href="http://localhost:4000/coderdojorimini//getting-started/">Getting Started</a></li>
              <li class="divider"></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/coderdojorimini//design/">Templates</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/coderdojorimini//design/grid/">Grid &amp; Colors</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/coderdojorimini//design/typography/typography/">Typography</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/coderdojorimini//design/page/">Page/Post</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/coderdojorimini//design/post-left-sidebar/">Post-Left-Sidebar</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/coderdojorimini//design/post-right-sidebar/">Post-Right-Sidebar</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/coderdojorimini//design/page-fullwidth/">Page Full-Width</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/coderdojorimini//blog/">Blog-Page</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/coderdojorimini//design/video/">Video</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/coderdojorimini//design/gallery/">Gallery</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/coderdojorimini//design/portfolio/">Portfolio</a></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/coderdojorimini//headers/">Header Styles</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/coderdojorimini//design/header-full-width-image/">Header with Full-Width-Image</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/coderdojorimini//design/header-image-pattern/">Header with Image and Pattern</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/coderdojorimini//design/header-image-color/">Header with image and color</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/coderdojorimini//design/header-logo-only/">Header Only With Logo</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/coderdojorimini//design/header-with-text/">Header With Text</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/coderdojorimini//design/no-header/">No Header</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/coderdojorimini//design/no-header-but-image/">No Header but Image</a></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/coderdojorimini//documentation/">Documentation</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/coderdojorimini//changelog/">Changelog</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/coderdojorimini//roadmap/">Roadmap</a></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/coderdojorimini//blog/">Blog</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/coderdojorimini//blog/archive/">Blog Archive</a></li>
